...
// Pet cooldown tick — Mimic speeds interval-based pet abilities without affecting character auras.
function petCdDt(dt){ return dt * (typeof P!=='undefined' && P.mimicPetRate>1 ? P.mimicPetRate : 1); }
